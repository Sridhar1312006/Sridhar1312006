...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=61DAFB&center=true&vCenter=true&width=500&lines=Digital+VLSI+Design+Enthusiast;RTL+Design+%26+FSM+Optimization;FPGA+Acceleration+%7C+Verilog+%26+SV;SoC+Protocols+(AXI%2C+AHB%2C+APB)" alt="Typing SVG" />
</p>

## 🚀 About Me
- 🔭 **Focus:** Digital VLSI Design, RTL coding, and Hardware Acceleration on FPGAs.
- 🌱 **Exploring:** Advanced SoC interconnect protocols (AXI, AHB, APB), Static Timing Analysis (STA), and Computer Architecture (RISC-V/MIPS).
- 🛠️ **Hands-on:** Synthesis and implementation workflows using Xilinx Vivado and Cadence tools.
